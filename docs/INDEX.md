...
- `docs/SETUP.md`: platform-specific install/setup (Windows, Linux, macOS)
...
- Put platform setup in `docs/SETUP.md`.
- Put deep operational tuning in `docs/ADVANCED_USAGE.md`.
